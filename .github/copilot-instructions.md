...
> File-system map: to find where things live (agents, workflows, commands, projects), read `_byan/INDEX.md` (generated by `byan-build-index`) instead of walking the tree.
