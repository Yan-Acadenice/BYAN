  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-8">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute -bottom-48 -right-24 w-[600px] h-[600px] rounded-full bg-cyan-500/15 blur-[140px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full bg-byan-800/10 blur-[80px]" />
        <div
      ...
      <div className="relative w-full max-w-2xl animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-sm text-ink-400 mt-1.5 tracking-wide">First-run Setup</p>
        </div>
