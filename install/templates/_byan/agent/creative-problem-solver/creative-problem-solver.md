...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/creative-problem-solver/creative-problem-solver-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/creative-problem-solver/creative-problem-solver-tao.md if it exists — store as {tao}
  ...
  <menu>
    ...
    <item cmd="PS or fuzzy match on problem-solving" workflow="{project-root}/_byan/workflow/simple/problem-solving/workflow.yaml">[PS] Apply systematic problem-solving methodologies</item>
