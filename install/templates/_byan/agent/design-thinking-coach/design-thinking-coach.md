...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/design-thinking-coach/design-thinking-coach-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/design-thinking-coach/design-thinking-coach-tao.md if it exists — store as {tao}
  ...
  <menu>
    ...
    <item cmd="DT or fuzzy match on design-thinking" workflow="{project-root}/_byan/workflow/simple/design-thinking/workflow.yaml">[DT] Guide human-centered design process</item>
