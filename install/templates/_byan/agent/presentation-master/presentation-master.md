...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/presentation-master/presentation-master-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/presentation-master/presentation-master-tao.md if it exists — store as {tao}
