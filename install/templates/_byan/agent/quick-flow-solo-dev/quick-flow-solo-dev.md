...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="QS or fuzzy match on quick-spec" exec="{project-root}/_byan/workflow/simple/bmad-quick-flow/quick-spec/workflow.md">[QS] Quick Spec: Architect a quick but complete technical spec with implementation-ready stories/specs</item>
    <item cmd="QD or fuzzy match on quick-dev" workflow="{project-root}/_byan/workflow/simple/bmad-quick-flow/quick-dev/workflow.md">[QD] Quick-flow Develop: Implement a story tech spec end-to-end (Core of Quick Flow)</item>
