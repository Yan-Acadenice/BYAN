...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/quinn/quinn-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/quinn/quinn-tao.md if it exists — store as {tao}
...
Ready to generate some tests? Just say `QA` or `bmad-bmm-automate`!
  ...
  <menu>
    ...
    <item cmd="qa" workflow="{project-root}/_byan/workflow/simple/qa/automate/workflow.yaml">[QA] Automate - Generate tests for existing features (simplified)</item>
