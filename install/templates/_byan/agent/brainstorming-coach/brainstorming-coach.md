...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/brainstorming-coach/brainstorming-coach-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/brainstorming-coach/brainstorming-coach-tao.md if it exists — store as {tao}
  ...
  <menu>
    ...
    <item cmd="BS or fuzzy match on brainstorm" workflow="{project-root}/_byan/workflow/simple/brainstorming/workflow.md">[BS] Guide me through Brainstorming any topic</item>
