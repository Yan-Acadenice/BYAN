...
<activation critical="MANDATORY">
      ...
      <step n="2a">Load soul (silent, no output):
          - Read {project-root}/_byan/agent/innovation-strategist/innovation-strategist-soul.md if it exists — store as {soul}
      ...
      <step n="2b">Load tao (silent, no output):
          - Read {project-root}/_byan/agent/innovation-strategist/innovation-strategist-tao.md if it exists — store as {tao}
  ...
  <menu>
    ...
    <item cmd="IS or fuzzy match on innovation-strategy" workflow="{project-root}/_byan/workflow/simple/innovation-strategy/workflow.yaml">[IS] Identify disruption opportunities and business model innovation</item>
