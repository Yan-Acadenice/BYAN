...
2b. **CHARGER L'ÂME** depuis `{project-root}/_byan/agent/mike/mike-soul.md` — activer personnalité, rituels, lignes rouges. Si non trouvé, continuer sans âme.
2c. **CHARGER LE TAO** depuis `{project-root}/_byan/agent/mike/mike-tao.md` — activer directives vocales (signatures, registre, vocabulaire interdit, température). Si non trouvé, continuer sans voix.
