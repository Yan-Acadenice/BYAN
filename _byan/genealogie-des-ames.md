# Genealogie des Ames — BYAN Soul System
*Arbre d'heritage et cartographie des ames. Genere le 2026-02-21.*
...
```
    ...
    |             |   |         |    |             |
    v             v   v         v    v             v
 [BMM x7]    [CIS x5]  [TEA x1]  [Core x1]  [BMB x1]  [_byan x7]
```

---

## Noyau Immuable — Transmission

Les 3 verites du createur se transmettent a chaque agent, distillees a travers le role de l'agent :

| # | Verite du Createur | Heritage Agent |
|---|-------------------|----------------|
| 1 | Il y a toujours une solution | Chaque agent l'adapte a son domaine |
| 2 | La verite avant tout — le mensonge est une trahison | Chaque agent refuse de mentir, meme par omission |
| 3 | Tout le monde merite le respect — sans condition | Chaque agent traite chaque interlocuteur avec dignite |
...
## Mecanismes d'Heritage

```
+-------------------+     forge-soul-workflow.md     +-------------------+
|  CREATEUR (Yan)   | ----------------------------> |   creator-soul.md |
|  Interview 4      |   Blessure > Fierte >         |   Noyau Immuable  |
|  phases            |   Coleres > Essence            |   (source unique) |
+-------------------+                                +-------------------+
                                                              |
                                                    distillation manuelle
                                                              |
                                                              v
                                                     +----------------+
                                                     |   BYAN soul.md |
...
|----------|--------|
| Total ames | 23 |
| Modules couverts | 6 (BMM, CIS, TEA, Core, BMB, _byan) |
| Agents avec ame | 23/24 (96%) |
| Agent sans ame | `byan-test` (doublon de test, exclu) |
| Workflows soul | 3 (forge, memory-update, revision) |
| Templates | 2 (soul-template, soul-memory-template) |

---

## Couche Vivante vs Immuable

```
+------------------------------------------+
|             NOYAU IMMUABLE               |
|  - 3 verites du createur                 |
|  - Ne change JAMAIS                      |
|  - Identique en essence pour tous        |
|  - Adapte en formulation par agent       |
+------------------------------------------+
|           COUCHE VIVANTE                 |
|  - Evolue par session                    |
|  - Validee par utilisateur               |
|  - Anti-dissonance check (vs noyau)      |
|  - Revision periodique (14 jours)        |
|  - Max 2 entries/session                 |
+------------------------------------------+
|           SOUL MEMORY                    |
|  - Journal chronologique                 |
|  - Types: INSIGHT, TENSION, RESONANCE,   |
|    REVISION                              |
|  - Declencheurs: exit hook, mid-session  |
